...
const SecurityApp: React.FC = () => {
  ...
  const simulateLocationChange = async (locationType: "home" | "away") => {
    let location;
    if (locationType === "home") {
      location = HOME_LOCATION;
    } else {
      // Simulate an away location (for demonstration purposes)
      location = { lat: HOME_LOCATION.lat + 0.05, lon: HOME_LOCATION.lon + 0.05 };
    }
    ...
    setSimulatedLocation(simulatedLocation);
    setLocationStatus(locationType);
    setLocationDebug(`Current Location: Lat ${currentLat}, Lon ${currentLon} | Simulated: Lat ${location.lat}, Lon ${location.lon}`);
  };
    ...
    <SafeAreaView style={styles.safeArea}>
      ...
      <ScrollView contentContainerStyle={styles.container}>
        <View style={styles.headerContainer}>
          ...
          <Text style={styles.title}>GE Security System</Text>
        </View>
        ...
        {cameraFeedVisible && (
          <View style={styles.cameraFeedContainer}>
            <Image
              source={{ uri: "https://example.com/camera-feed.jpg" }} // Replace with actual camera feed URL
